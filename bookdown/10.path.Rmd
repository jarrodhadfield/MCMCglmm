...
m.path<-MCMCglmm(cbind(e-mean(e), prod-mean(prod), rw-mean(rw))~trait-1+path(2, 3, 3)+path(3, 1, 3)+path(1, 2, 3), rcov=~idhm(trait):units, data=Canada, family=rep("gaussian", 3),prior=list(R=list(V=diag(3),nu=0.002)))
```
