...
Note that when we do this, pruning is automatically done. The phylogeny is shown in Figure \@ref(fig:bird-families2) and we can see that all internal nodes have been stripped out except those that connect our four families.

``` {r bird-families2, echo=FALSE, include=TRUE, fig.cap="A subset of the phylogeny of bird families from \\citet{Sibley.1990} for Tits (Paridae), Treecreepers (Certhiidae),  Cranes (Gruidae) and the Ostriches (Struthionidae)", fig.width=7, fig.height=7}
