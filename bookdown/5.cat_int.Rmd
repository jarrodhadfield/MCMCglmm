...
We can seen that this is conceptually identical to our virus-line example but rather than specifying the classifying variable inside $\texttt{idh()}$ or $\texttt{us()}$, as we could for $\texttt{virus}$, the classifying variable is actually the column names of the terms.
...
### Marginal Priors for Covariances


### Marginal Priors for Correlations
