...
m.tufted.a<-MCMCglmm(cbind(Other, Herring, SandLance, Pollock, Capelin)~trait-1, data=tufted_mm, rcov=~us(trait):units, family="multinomial", longer=20)

m.tufted.b<-MCMCglmm(cbind(Capelin, Herring, SandLance, Pollock, Other)~trait-1, data=tufted_mm, rcov=~us(trait):units, family="multinomial", longer=20)
